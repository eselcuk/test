...
public class Time implements Comparable<Time>, Serializable {
     ...
     * This ensures that Time objects start in a consistent state. @throws
    ...
    /**
     * Set a new time value using universal time. Perform validity checks on the
     * data. Set invalid values to zero.
     *
     * @param h the hour
     * @param m the minute
     * @param s the second
     ...
     *
     * @return a <code>String</code> representation of the time in
     ...
     *
     * @return a <code>String</code> representation of the time in standard-time
     * format
     */
    ...
    public int compareTo(Time t) {
        ...
        long t1 = this.hour * 60 + this.minute * 60 + this.second;
        long t2 = t.hour * 60 + t.minute * 60 + t.second;
        if (t1 > t2) {
            return 1;
        } else if (t1 < t2) {
            return -1;
