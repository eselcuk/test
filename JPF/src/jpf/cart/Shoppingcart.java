...
public class Shoppingcart {
     ...
     * incremented.
     *
     * @param product the <code>ProductSmpl</code> that defines the type of shopping cart item
     * @see ShoppingCartItem
     */
    public synchronized void addItem(ProductSmpl product) {
     ...
     * @see ShoppingCartItem
     */
    public synchronized void update(ProductSmpl product, String quantity) {
    ...
    public synchronized double getSubtotal() {
        ...
        for (ShoppingCartItem scItem : items) {
            ...
            ProductSmpl product = (ProductSmpl) scItem.getProduct();
